    ...
    <div className="w-full flex justify-between items-center px-10 py-6 text-gray-900">
      <Link href='/'>
        ...
        <Image
          ...
          className="h-12 md:h-16 lg:h-20 hidden sm:flex"
          width={200}
          height={200}
          alt="TransitChat Logo"
        />
      ...
      <div className="gap-5 flex items-center">
        <Link href='/gtfs-to-geojson' className="text-tcOrange hover:text-yellow-400 hidden sm:flex">GTFS To GeoJson Converter</Link>
